...
$sql=$con->query("insert into products (productName,productCompany,productPrice,productDescription,productAvailability,productImage1,productImage2,productImage3) 
VALUES ('$productname','$productcompany',$productprice,'$productdescription','$productavailability','$productimage1','$productimage2','$productimage3')") or die("product not added");
