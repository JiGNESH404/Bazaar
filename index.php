...
while ($row=mysqli_fetch_array($ret)) 
{
	...
	$rent_Prod = mysqli_query($con, "select * from users_product where product_id=$row[id]");
	$details = mysqli_fetch_array($rent_Prod);
									...
									<div class="col-2">
										<div class="product-info">
											...
											<div class="product-price">	
												...
												<?php if($details['category']=="rent"){
													/* $_SESSION['category'] = "rent"; */
													?>
												Rent
												<?php } ?>
												<?php if($details['category']=="sell"){?>
												Add to Cart
												<?php }?>
												<?php if(!$details['category']=="sell"){?>
												Add to Cart
