				...
				<div class="shopping-cart">
					<div class="col-md-12 col-sm-12 shopping-cart-table ">
						<div class="table-responsive">
							<form name="cart" action="payment-method.php" enctype="multipart/form-data" method="post">
								<?php
								if (!empty($_SESSION['cart'])) {
								?>
									<table class="table table-bordered">
										...
										<tbody>
											...
											<?php }
											$_SESSION['rent_array'] = $rent_array;
											}
											$_SESSION['pid'] = $pdtid;
											?>
								...
								<tr>
									<th>
										...
										<div class="cart-grand-total">
											<?php if($rent==1)
											$totalprice = intval($totalprice) + 1000;
											?>
											Grand Total<span class="inner-left-md"><?php echo $_SESSION['tp'] = "$totalprice" . ".00"; ?></span>
											<?php if($rent==1)
											{?>
											<small style="color: red;">*Deposit amount = 1000</small>
											<?php }?> 
										</div>
									</th>
								</tr>
								...
								<tr>
									<td>
										...
										<?php if($rent == 1){?>
											...
											<button onclick="document.getElementById('actual_btn').click()" required  class="btn btn-primary"><span style="color: red;">*</span>Upload Id</button>
											<input required type="file" name="idproof" id="actual_btn" style="display: none;">
										<?php } ?>
